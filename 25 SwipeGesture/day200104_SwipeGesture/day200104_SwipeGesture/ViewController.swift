...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        imgDowm.append(UIImage(named: "arrow-down-black.png")!)
        imgDowm.append(UIImage(named: "arrow-down-red.png")!)
